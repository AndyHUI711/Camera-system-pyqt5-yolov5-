...
"")
        ...
        self.ComboBox_weight = QtWidgets.QComboBox(self.groupBox_8)
        self.ComboBox_weight.setMinimumSize(QtCore.QSize(0, 35))
        self.ComboBox_weight.setStyleSheet("QComboBox QAbstractItemView {\n"
"font-family: \"Microsoft YaHei\";\n"
"font-size: 16px;\n"
...
"")
        ...
        self.ComboBox_weight.addItem("")
        self.ComboBox_weight.addItem("")
        self.horizontalLayout_2.addWidget(self.ComboBox_weight)
...
"")
    ...
    def retranslateUi(self, mainWindow):
        ...
        mainWindow.setWindowTitle(_translate("mainWindow", "YOLOv5 User Interface"))
        self.label_4.setText(_translate("mainWindow", "YOLOv5 User Interface"))
        ...
        self.ComboBox_weight.setItemText(0, _translate("mainWindow", "yolov5s.pt"))
        self.ComboBox_weight.setItemText(1, _translate("mainWindow", "yolov5m.pt"))
        self.ComboBox_weight.setItemText(2, _translate("mainWindow", "yolov5l.pt"))
        self.ComboBox_weight.setItemText(3, _translate("mainWindow", "yolov5x.pt"))
        self.label_10.setText(_translate("mainWindow", "Input"))
        self.fileButton.setToolTip(_translate("mainWindow", "Files"))
        self.cameraButton.setToolTip(_translate("mainWindow", "Cam"))
        self.rtspButton.setToolTip(_translate("mainWindow", "rtsp"))
        self.label_2.setText(_translate("mainWindow", "IoU threshold"))
        self.label.setText(_translate("mainWindow", "Confidence threshold"))
        self.label_8.setText(_translate("mainWindow", "FPS"))
        self.checkBox.setText(_translate("mainWindow", "Open"))
